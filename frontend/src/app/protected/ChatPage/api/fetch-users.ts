...
export async function getUserGeust(id: string) {
  try {
    ...
    const res = await axios.get(
      process.env.Backend_URL + `/user/getUserGeust/${id}`,
      {
        headers: {
...
export async function getAllUsers(author: string) {
  try {
    const token = Cookies.get("access_token");
    const res = await axios.get(process.env.Backend_URL + "/user/all", {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
...
export async function getValideUsers(id: string) {
  try {
    const token = Cookies.get("access_token");
    const res = await axios.get(
      process.env.Backend_URL + `/user/getValideUsers/${id}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
export async function getValideChannels(id: string) {
  try {
    const token = Cookies.get("access_token");
    const res = await axios.get(
      process.env.Backend_URL + `/channel/getValideChannels/${id}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
export async function getUserForMsg(senderId: string) {
  try {
    const token = Cookies.get("access_token");
    const res = await axios.get(
      process.env.Backend_URL + `/messages/getUserForMsg/${senderId}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  try {
    ...
    const res = await axios.get(
      process.env.Backend_URL +
        `/user/checkIsBlocked/${senderId}/${receivedId}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
export async function getChannelGeust(id: string) {
  try {
    const token = Cookies.get("access_token");
    const res = await axios.get(
      process.env.Backend_URL + `/user/getChannelGeust/${id}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
export async function getMembersChannel(id: string) {
  try {
    const token = Cookies.get("access_token");
    const res = await axios.get(
      process.env.Backend_URL + `/channel/getMembersChannel/${id}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
export async function usersCanJoinChannel(senderId: string, channelId: string) {
  try {
    ...
    const res = await axios.get(
      process.env.Backend_URL +
        `/user/getUsersCanJoinChannel/${senderId}/${channelId}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
export async function startGameing(senderId: string) {
  try {
    ...
    const res = await axios.post(
      process.env.Backend_URL + `/user/startGameing/${senderId}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
export async function finishGaming(senderId: string) {
  try {
    const token = Cookies.get("access_token");
    const res = await axios.post(
      process.env.Backend_URL + `/user/finishGaming/${senderId}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
