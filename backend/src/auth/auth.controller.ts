...
export class AuthController {
  ...
  async callbackWith42(@Req() req: any, @Res() res: Response) {
    ...
    if (diff < 120) {
      ...
      return res.redirect("http://192.168.1.7:3000/protected/SettingsPage");
    }

    if (req.user.isTwoFactorAuthEnabled)
      return res.redirect("http://192.168.1.7:3000/public/Checker2faAuth");

    res.cookie("access_token", ret.access_token);
    res.redirect("http://192.168.1.7:3000/protected/DashboardPage");
  }
}
