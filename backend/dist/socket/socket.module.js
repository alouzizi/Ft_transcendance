...
exports.SocketGatewayModule = SocketGatewayModule = __decorate([
    (0, common_1.Module)({
        providers: [socket_gateway_1.SocketGateway, socket_service_1.SocketGatewayService, messages_service_1.MessagesService, user_service_1.UserService, channel_service_1.ChannelService, game_service_1.PongServise],
    })
], SocketGatewayModule);
